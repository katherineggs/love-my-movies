...
> It is in python... couldn't understand docker toolbox
> If you run the dockerfile app:"last version" it goes well but you can't access to the web
> Run -> python movie.py to see my work
